...
def set_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="A photo of a bench",  # "A photo of a humanoid sculpture",  #
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="A photo of a bench and a bag",  # "A photo of a humanoid cyborg",  # ,
        help="xxx",
    )
    ...
    parser.add_argument(
        "--config",
        type=str,
        default=r"C:\Users\lluis\OneDrive\Documentos\ETH\DL\DiffEdit-stable-diffusion\DiffEdit\configs\stable-diffusion\v1-inference.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default=r"C:\Users\lluis\OneDrive\Documentos\ETH\DL\DiffEdit-stable-diffusion\DiffEdit\models\ldm\stable-diffusion\v1-5-pruned-emaonly.ckpt",
    ...
    parser.add_argument(
        "--origin_image", type=str, help="xxx", default=None, required=False
    )
...
def get_mask(model, src, dst, init_latent, n: int, ddim_steps, clamp_rate: float = 3):
    """
...
def resize_image1_into_image2(image1: Image.Image, image2: Image.Image) -> Image.Image:
    image1 = image1.resize(image2.size, resample=Image.Resampling.LANCZOS)
    return image1
