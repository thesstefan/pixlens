...
from pixlens.editing.impl.open_edit.models.OpenEdit_model import OpenEditModel
...
class OpenEditOptimizer:
    ...
    def __init__(self, opt):
        ...
        self.optimizer_P = self.open_edit_model_on_one_gpu.create_P_optimizers(
            opt
        )
        self.old_lr = opt.lr

    def run_opt_one_step(
        self, data, ori_cap, new_cap, alpha, global_edit=False
    ):
