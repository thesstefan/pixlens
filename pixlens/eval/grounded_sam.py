...
class GroundedSAM(PromptDetectAndBBoxSegmentModel):
    def __init__(
        ...
        grounding_dino_type: eval_grounding_dino.GroundingDINOType = eval_grounding_dino.GroundingDINOType.SWIN_T,
        ...
        grounding_dino = eval_grounding_dino.GroundingDINO(
            grounding_dino_type, device=device
        )

        super(GroundedSAM, self).__init__(
            grounding_dino, sam_predictor, detection_confidence_threshold
        )
